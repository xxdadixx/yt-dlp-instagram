"""
config/translations.py - Clean typography translations without raw emojis.
"""
...
TRANSLATIONS = {
    "th": {
        ...
        "url_placeholder": "วางลิงก์ Instagram ที่นี่ (รองรับทั้ง /p/, /reel/, และ /stories/)...",
        ...
        "warn_story_need_cookie": "การดาวน์โหลด Instagram Story จำเป็นต้องนำเข้าไฟล์ cookies.txt ก่อนใช้งาน",
        "warn_need_ffmpeg": "โหมดแปลงเสียง (MP3) จำเป็นต้องมี ffmpeg.exe ในระบบ",
        "cookie_warn_title": "คำเตือนความปลอดภัย (Cookie Security)",
        "cookie_warn_msg": "ข้อควรทราบก่อนนำเข้าไฟล์ Cookie:\n\n1. ไฟล์ cookies.txt บรรจุข้อมูล Session การล็อกอินของคุณ ห้ามส่งต่อให้ผู้อื่น\n2. โปรแกรมจะกรองบันทึกเฉพาะ Instagram/Facebook และตัด Cookie อื่นทิ้งทั้งหมด\n\nต้องการดำเนินการต่อหรือไม่?",
        ...
        "tooltip_delete_card": "ลบรายการนี้ออกจากคิว",
        "btn_open_file": "เปิดไฟล์",
        "scope_all": "🌟 ทั้งหมด (รูป + วิดีโอ)",
        "scope_videos_only": "🎬 เฉพาะวิดีโอ / Reels",
        "scope_photos_only": "🖼️ เฉพาะรูปภาพ",
    },
    "en": {
        "title": "Instagram Pro Downloader - Studio Inspector",
        "url_group": "Instagram URLs (Supports Posts, Reels, Carousels, Stories & Highlights)",
        "url_placeholder": "Paste Instagram URLs here (Supports /p/, /reel/, and /stories/)...",
        ...
        "tooltip_delete_card": "Remove this item from queue",
        "btn_open_file": "Open",
        "scope_all": "🌟 All Media (Photos & Videos)",
        "scope_videos_only": "🎬 Videos & Reels Only",
        "scope_photos_only": "🖼️ Photos Only",
    },
}
